...
def main(
    ...
    def model_optimizer(config, return_model=False):
        ...
        model.auto_initialize_baseline_states(train_data["y"][0:52])  # 72
        ...
        if grid_search:
            SKF_optimizer_runner = tune.run(
                ...
                config={
                    ...
                    "slope": tune.grid_search([0.003, 0.005, 0.006]),
