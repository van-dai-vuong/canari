...
sigma_v_fix = 0.04261837863185459
look_back_len_fix = 16
SKF_std_transition_error_fix = 1e-4
SKF_norm_to_abnorm_prob_fix = 1e-4

# Fix parameters
# sigma_v_fix = 0.015677715161959378
# look_back_len_fix = 61
# SKF_std_transition_error_fix = 0.0006231808655929656
# SKF_norm_to_abnorm_prob_fix = 0.0007612703586240682
