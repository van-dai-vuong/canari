...
sigma_v_fix = 0.11063121488330857
look_back_len_fix = 24
SKF_std_transition_error_fix = 1e-4
SKF_norm_to_abnorm_prob_fix = 1e-4

# Fix parameters
# sigma_v_fix = 0.09564564216031646
# look_back_len_fix = 24
# SKF_std_transition_error_fix = 7.757432445157692e-05
# SKF_norm_to_abnorm_prob_fix = 3.821302303606165e-06
...
def main(
    ...
    df_raw.columns = ["displacement_x", "water_level", "temp_min", "temp_max"]
    lags = [0, 4, 4, 4]
...
def training(model, data_processor, num_epoch: int = 50):
    ...
    model.auto_initialize_baseline_states(data_processor.train_split["y"][0:102])
